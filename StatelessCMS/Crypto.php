...
/**
 * Create and verify nonces and other cryptography strings
 */
class Crypto {
    ...
    /**
     * Verify a clear-text string against a hash
     * 
    ...
    /**
     * Returns pepper generated by $uuid
     * 
    ...
    /**
     * Joins salt and pepper with the string
     * 
    ...
    /**
     * Check for pepper at the beginning of $str
     * 
     * @param string $str The string to check
    ...
    /**
     * Check $str for spice (salt and pepper)
     * 
     * @param string $str The string to check
    ...
    /**
     * Remove $salt from $str, if it exists
     * 
    ...
    /**
     * Remove pepper from $str, if it exists
     * 
    ...
    /**
     * Remove $salt and pepper from $str, if it exists
     * 
    ...
    /**
     * Get an OpenSSL initialization vector
     * 
    ...
    public static function decrypt(
        ...
        if (in_array($method, openssl_get_cipher_methods())) {
            // Split off the iv and tag
            $ivlen = openssl_cipher_iv_length($method);
            $taglen = 16;
    
            $iv = substr($str, 0, $ivlen);
            $tag = substr($str, strlen($str) - $taglen);
            $str = substr($str, $ivlen, strlen($str) - $ivlen - $taglen);
    ...
    /**
     * Returns a timestamp to be used with a nonce
     * 
    ...
    public static function nonce(
        ...
        // Create payload hash
        $hash = $time . Crypto::hash($action . $uuid . $obid);
    ...
    /**
     * Generates a hidden nonce field
     * 
